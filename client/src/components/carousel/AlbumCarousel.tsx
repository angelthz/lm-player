...
import { AlbumCardFlexMemo } from "../cards/AlbumCardFlex";

export function AlbumCarousel({ albums }: { albums: AlbumDTO[] }) {
    //context
    ...
    useEffect(() => { console.log(`%cRendering Album Carousel`, 'background: #1a1a1a; color: #9B93ED;') })
